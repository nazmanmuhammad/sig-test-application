                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <select name="type" class="form-select" onchange="this.form.submit()">
                                ...
                                <option value="3" {{ request('type') == '3' ? 'selected' : '' }}>Government</option>
                                <option value="4" {{ request('type') == '4' ? 'selected' : '' }}>Traditional Medicine & Suplement</option>
                                <option value="13" {{ request('type') == '13' ? 'selected' : '' }}>Beauty, Cosmetics & Personal Care</option>
                                <option value="14" {{ request('type') == '14' ? 'selected' : '' }}>Media RTU</option>
                                <option value="15" {{ request('type') == '15' ? 'selected' : '' }}>K3L Products</option>
                                <option value="16" {{ request('type') == '16' ? 'selected' : '' }}>ALKES & PKRT</option>
                                <option value="17" {{ request('type') == '17' ? 'selected' : '' }}>Feed, Pesticides & PSAT</option>
                                <option value="18" {{ request('type') == '18' ? 'selected' : '' }}>Others</option>
                                <option value="19" {{ request('type') == '19' ? 'selected' : '' }}>Research / Academic Purpose</option>
                                <option value="20" {{ request('type') == '20' ? 'selected' : '' }}>Dioxine Udara</option>
                            </select>
                        </div>
                        <div class="col-md-3">
